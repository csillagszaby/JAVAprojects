...
class DeviceEditForm extends React.Component {
        ...
        this.state = {
            ...
            formControls: {
                ...
                maxEnergyConsumption: {
                    value: this.device.maxEnergyConsumption,
                    placeholder: '100',
                    valid: true,
                    touched: true
                },
                averageEnergyConsumption: {
                    value: this.device.averageEnergyConsumption,
                    placeholder: '70',
                    valid: true,
                    touched: true
                },
                selectedClient: {
                    value: this.device.clientAccountDTO.id,
    ...
    updateDevice(device,clientAccountId) {
        return API_DEVICES.putUpdateDevice(device,clientAccountId, (result, status, error) => {
...
handleDropdownChange = event => {
    ...
    handleSubmit() {
        ...
        console.log(device);
        this.updateDevice(device,this.state.formControls.selectedClient.value);
    }
